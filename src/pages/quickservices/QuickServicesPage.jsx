...
function QuickServicesPage() {
  return (
    <div className="min-h-screen bg-[#FAFBFF]">
      ...
      <div className="flex flex-col gap-3 lg:px-10 px-3 w-full lg:w-[1010px] xl:w-[1500px] justify-center m-auto">
        ...
        <div className="flex flex-col gap-8 py-6">
          ...
          <div className="flex flex-col  md:flex-row justify-center items-center  flex-wrap gap-4">
            <ArtisanService />
            <div className="flex lg:justify-end w-full my-8 justify-center">
              <Button
                variant="bordered"
                color="primary"
